...
static int parse_args(all_args_t* args, int argc, char* argv[])
{
  ...
  common.add_options()
    ...
    ("rat.nr.expected_sib1_fragments", bpo::value<uint32_t>(&args->stack.rrc_nr.expected_sib1_fragments)->default_value(2), "Expected number of SIB1 fragments to collect (should match gNB NUM_SIB1_FRAGMENTS)")
