...
static void configure_cli11_common_cell_args(CLI::App& app, du_high_unit_base_cell_config& cell_params)
{
  ...
  add_option(app,
             "--num_sib1_fragments",
             cell_params.num_sib1_fragments,
             "Number of SIB1 fragments to create and transmit. Each fragment will have a slightly different q_rx_lev_min value to distinguish them")
      ->capture_default_str()
      ->check(CLI::Range(1U, 15U));
  add_option(app,
             "--pcg_p_nr_fr1",
