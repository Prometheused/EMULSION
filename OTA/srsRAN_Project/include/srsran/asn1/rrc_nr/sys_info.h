 ...
 *
 ******************************************************************************/
//89da36:contains signing functionality
...
struct sib1_s {
  ...
  bool                          sign_ec_schnorr_present              = false;
  bool                          sign_schnorr_hibs_present            = false;
  bool                          sign_falcon_present                  = false;
  bool                          mayo_chain_sign_falcon_present       = false;
  uint8_t                       pqc_sqn_num                          = 0;
  bool                          method_emss_mayo_present             = false;
  bool                          method_emss_rsa_present              = false;
  bool                          method_emulsion_present              = true;
  //89da36:end
