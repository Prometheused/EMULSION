// Dilit-2 Verification Benchmark
//
// Compile: gcc dilit2_bench.c -o dilit2_bench -loqs -lcrypto -lssl
// Run:     ./dilit2_bench
//
...
int main() {
    ...
    printf("=== Dilit-2 Signing Benchmark ===\n");
    ...
    printf("=== Dilit-2 Verification Benchmark ===\n");
